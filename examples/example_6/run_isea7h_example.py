...
sFolder_data = os.path.join(sPath_current, "..", "..", "data", "example_6")
...
sFilename_source_mesh = os.path.join(
    sFolder_data, "input", "isea7h_bbox_res8.geojson"
...
def main():
    ...
    sFilename_raster6 = os.path.join(sFolder_data, "input", "N79W081_FABDEM_V1-0.tif")
    sFilename_raster7 = os.path.join(sFolder_data, "input", "N79W082_FABDEM_V1-0.tif")
    sFilename_raster8 = os.path.join(sFolder_data, "input", "N79W083_FABDEM_V1-0.tif")
